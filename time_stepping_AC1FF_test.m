...
%% Compute solution
[sol_alpha,sol_beta,sol_gamma,sol_xi] = time_stepping_AC1FF(S_bulk,M_bulk,Nodes_bulk,Elements_bulk,S_surf,M_surf,B, Nodes_surf, Elements_surf, alpha_0, xi_0, T, N, k, l, epsilon, sigma, delta, kappa);
