...
function [L2_int_bdry, H1_int_bdry, L2_int, H1_int] = convergence_GMS1FF(N_Gamma,l,u)
...
%% Coefficients
epsilon = 0.5; % big interaction length
sigma = 1; % slow separation
delta = 0.5; % small interaction length
kappa = 1; % fast separation

%% Compute solution
[sol_alpha,sol_beta,sol_gamma,sol_xi] = time_stepping_GMS1FF(S_bulk,M_bulk,S_surf,M_surf,B,B_I,Nodes_bulk, Elements_bulk, Nodes_surf, Elements_surf, alpha_0, xi_0, T, N, k, l, epsilon, sigma, delta, kappa);
