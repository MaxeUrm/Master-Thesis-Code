%% Finer discretization error improvement plots - GMS1FF
...
% [h_bm, tau_bm, err_L2_bm, err_H1_bm, L2_int_bm, H1_int_bm] = convergence_GMS1(0.03,1000,u);
...
for i = 1:length(l_array)
    [L2_int_bdry, H1_int_bdry, L2_int, H1_int] = convergence_GMS1FF(200,l_array(i),u);
...
% dof = 400
for i = 1:length(l_array)
    [L2_int_bdry, H1_int_bdry, L2_int, H1_int] = convergence_GMs1FF(400,l_array(i),u);
...
% dof = 800
for i = 1:length(l_array)
    [L2_int_bdry, H1_int_bdry, L2_int, H1_int] = convergence_GMS1FF(800,l_array(i),u);
...
for i = 1:length(dof_array)
    [L2_int_bdry, H1_int_bdry, L2_int, H1_int] = convergence_GMS1FF(dof_array(i),1,u);
...
% l = 4
for i = 1:length(dof_array)
    [L2_int_bdry, H1_int_bdry, L2_int, H1_int] = convergence_GMS1FF(dof_array(i),4,u);
...
% l = 16
for i = 1:length(dof_array)
    [L2_int_bdry, H1_int_bdry, L2_int, H1_int] = convergence_GMS1FF(dof_array(i),16,u);
