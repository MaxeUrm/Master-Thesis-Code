...
%% Compute solution
[sol_alpha,sol_beta,sol_gamma,sol_xi] = time_stepping_AC1(S_bulk,M_bulk,S_surf,M_surf,Nodes_bulk, Elements_bulk, Nodes_surf, Elements_surf, alpha_0, xi_0, T, N, epsilon, sigma, delta, kappa);
...
%% Video file creation
%
video = VideoWriter('CH_AC_vid','MPEG-4');
