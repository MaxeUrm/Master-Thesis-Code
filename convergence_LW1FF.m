...
function [L2_int_bdry, H1_int_bdry, L2_int, H1_int] = convergence_LW1FF(N_Gamma,l,u)
...
%% Coefficients
epsilon = 0.75; % big interaction length
sigma = 0.25; % slow separation
delta = 0.05; % small interaction length
kappa = 5; % fast separation

%% Compute solution
[sol_alpha,sol_beta,sol_gamma,sol_xi] = time_stepping_LW1FF(S_bulk,M_bulk,S_surf,M_surf,B,B_I,Nodes_bulk, Elements_bulk, Nodes_surf, Elements_surf, alpha_0, xi_0, T, N, k, l, epsilon, sigma, delta, kappa);
