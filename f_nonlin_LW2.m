% Nonlinear function for LW2

function sol = f_nonlin_LW2(ML_bulk, ML_surf, x, N_Omega, N_Gamma, epsilon, delta, weights, alpha_n, xi_n)
    ...
    sol = [zeros(N_Omega,1); v1; zeros(N_Gamma,1); v2; zeros(N_Gamma,1)];
