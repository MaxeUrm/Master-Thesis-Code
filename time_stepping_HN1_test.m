%% time_stepping_HN1 test for CH-equation with HN boundary values
...
caxis([-1,1])
shading interp
xlabel('$t=0.05$','FontSize',fontSize)
hold off

nexttile

hold on
alpha_0 = sol_alpha(:,150);
trisurf(Elements_bulk, Nodes_bulk(:,1), Nodes_bulk(:,2), alpha_0, 'EdgeColor', 'none');
colormap('jet')
pbaspect([2 2 1])
view(0,90)
...
caxis([-1,1])
shading interp
xlabel('$t=0.15$','FontSize',fontSize)
hold off

nexttile

hold on
alpha_0 = sol_alpha(:,300);
trisurf(Elements_bulk, Nodes_bulk(:,1), Nodes_bulk(:,2), alpha_0, 'EdgeColor', 'none');
colormap('jet')
pbaspect([2 2 1])
view(0,90)
...
caxis([-1,1])
shading interp
xlabel('$t=0.3$','FontSize',fontSize)
hold off
...
caxis([-1,1])
shading interp
xlabel('$t=0.5$','FontSize',fontSize)
hold off
...
caxis([-1,1])
shading interp
xlabel('$t=2.5$','FontSize',fontSize)
hold off
%}

%% Video file creation

video = VideoWriter('CH_HN1_vid','MPEG-4');
