...
function [sol_alpha,sol_beta,sol_gamma,sol_xi,sol_zeta,sol_eta] = time_stepping_GMS1FF(S_bulk,M_bulk,S_surf,M_surf,B,Nodes_bulk, Elements_bulk, Nodes_surf, Elements_surf, alpha_0, xi_0, T, N, k, l, epsilon, sigma, delta, kappa)
    ...
    K = spalloc((2*k*N_Omega + 2*(l+1)*N_Gamma), (2*k*N_Omega + 2*(l+1)*N_Gamma), 4*(l+k)*(N_Omega + N_Gamma));
        ...
        for i = 1:k
            ...
            K(((i-1)*N_Omega +1):(i * N_Omega),(2*k*N_Omega + (2*l+1)*N_Gamma +1):(2*k*N_Omega + 2*(l+1)*N_Gamma)) = -(tau/k) * B;
        end
        ...
        for i = 1:l
            ...
            K((2*k*N_Omega + (i-1)*N_Gamma +1):(2*k*N_Omega + i*N_Gamma),(2*k*N_Omega + (2*l+1)*N_Gamma +1):(2*k*N_Omega + 2*(l+1)*N_Gamma)) = (tau/l) * M_surf;
        end
        ...
        % fifth equation
        K((2*k*N_Omega + 2*l*N_Gamma +1):(2*k*N_Omega + (2*l+1)*N_Gamma),((k-1)*N_Omega +1):(k * N_Omega)) = transpose(B);
        K((2*k*N_Omega + 2*l*N_Gamma +1):(2*k*N_Omega + (2*l+1)*N_Gamma),(2*k*N_Omega + l*N_Gamma +1):(2*k*N_Omega + (l+1)*N_Gamma)) = -M_surf;
        
        % sixth equation
        K((2*k*N_Omega + (2*l+1)*N_Gamma +1):(2*k*N_Omega + (2*l+2)*N_Gamma),((2*k-1)*N_Omega +1):(2* k * N_Omega)) = transpose(B);
        K((2*k*N_Omega + (2*l+1)*N_Gamma +1):(2*k*N_Omega + (2*l+2)*N_Gamma),(2*k*N_Omega + (2*l)*N_Gamma +1):(2*k*N_Omega + (2*l+1)*N_Gamma)) = -M_surf;
