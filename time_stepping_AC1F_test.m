...
%% Compute solution
[sol_alpha,sol_beta,sol_gamma,sol_xi] = time_stepping_AC1F(S_bulk,M_bulk,Nodes_bulk,Elements_bulk,S_surf,M_surf, Nodes_surf, Elements_surf, alpha_0, xi_0, T, N, k, l, epsilon, sigma, delta, kappa);
...
video = VideoWriter('CH_AC1F_vid','MPEG-4');
