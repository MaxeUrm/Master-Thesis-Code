%% Time_stepping_GMS1F test for CH-equation with GMS Boundary values
...
[B,Bdry] = assembly_tracematrix(Nodes_bulk,Nodes_bdry,Nodes_surf,N_Omega,N_bdry,N_Gamma);
...
%% Compute solution
[sol_alpha,sol_beta,sol_gamma,sol_xi,sol_zeta,sol_eta] = time_stepping_GMS1FF(S_bulk,M_bulk,S_surf,M_surf,B, Nodes_bulk, Elements_bulk, Nodes_surf, Elements_surf, alpha_0, xi_0, T, N, k, l, epsilon, sigma, delta, kappa);
...
video = VideoWriter('CH_GMS1FF_vid','MPEG-4');
...
figure(11)
subplot(1,2,1)
plot(t,m1,'Color',jeansblue,'LineWidth',2)
hold on
...
plot(t,m2,'Color',deepcarrotorange,'LineWidth',2)
...
for i = 1:(N+1)
    ...
    m3(i) = m1((i-1)*k +1) + m2((i-1)*l +1);
end

plot(t,m3,'Color',loyolagreen,'LineWidth',2)
