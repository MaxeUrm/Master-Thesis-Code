...
%% Compute solution
[sol_alpha,sol_beta,sol_gamma,sol_xi,sol_zeta,sol_eta] = time_stepping_GMS1(S_bulk,M_bulk,S_surf,M_surf,Nodes_bulk, Elements_bulk, Nodes_surf, Elements_surf, alpha_0, xi_0, T, N, epsilon, sigma, delta, kappa);
...
%% Video file creation
%
video = VideoWriter('CH_GMS1_vid','MPEG-4');
...
figure(10)
subplot(1,2,1)
plot(t,m1,'Color',trueblack,'LineWidth',2)
hold on
...
% combined mass
plot(t,m1+m2,'Color',loyolagreen,'LineWidth',2)
