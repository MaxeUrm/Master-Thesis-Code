...
%% Compute solution
[sol_alpha,sol_beta,sol_gamma,sol_xi,sol_zeta] = time_stepping_LW1F(S_bulk,M_bulk,S_surf,M_surf,Nodes_bulk, Elements_bulk, Nodes_surf, Elements_surf, alpha_0, xi_0, T, N, k, l, epsilon, sigma, delta, kappa);
...
video = VideoWriter('CH_LW1F_vid','MPEG-4');
