...
function [sol_alpha,sol_beta,sol_gamma,sol_xi,sol_zeta] = time_stepping_LW1(S_bulk,M_bulk,S_surf,M_surf,Nodes_bulk, Elements_bulk, Nodes_surf, Elements_surf, alpha_0, xi_0, T, N, epsilon, sigma, delta, kappa)
