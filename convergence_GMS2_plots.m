...
L2_err_matrix = zeros(6,8);
H1_err_matrix = zeros(6,8);
...
for i = 1:6
    for j = 1:8
        ...
        [h, tau, err_L2, err_H1, L2_int, H1_int] = convergence_GMS2(h_vec(i),tau_vec(j),u,nr);
