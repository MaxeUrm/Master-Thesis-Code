%% Time_stepping_LW1F test for CH-equation with LW Boundary values
...
%% Compute solution
[sol_alpha,sol_beta,sol_gamma,sol_xi,sol_zeta] = time_stepping_LW1FF(S_bulk,M_bulk,S_surf,M_surf,B, Nodes_bulk, Elements_bulk, Nodes_surf, Elements_surf, alpha_0, xi_0, T, N, k, l, epsilon, sigma, delta, kappa);
...
%% Video file creation
%{
video = VideoWriter('CH_LW1FF_vid','MPEG-4');
