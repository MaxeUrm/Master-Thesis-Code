...
function [sol_alpha,sol_beta,sol_gamma,sol_xi,sol_zeta] = time_stepping_LW1FF(S_bulk,M_bulk,S_surf,M_surf,B,B_I,Nodes_bulk, Elements_bulk, Nodes_surf, Elements_surf, alpha_0, xi_0, T, N, k, l, epsilon, sigma, delta, kappa)
    ...
    for i = 1:N
        ...
        fun = @(x) (K * x) + b + f_nonlin_LW1F(ML_bulk, ML_surf, x, N_Omega, N_Gamma, epsilon, delta, k, l) - v ; % final funtion to solve
        %}
        ...
        tol = 0.000000001;
        sol_n = newton_solver_LW1F(ML_bulk, ML_surf, K, fun, N_Omega, N_Gamma, epsilon, delta, sol_n, tol, k, l);
